...
print("""<div class="container"><h1 class="text-center" >Citations sur le thème des virus</h1></div>""")
...
cur = conn.cursor()
cur.execute("""SELECT * FROM blagues WHERE citations LIKE '%Coronavirus%' OR citations LIKE '%cure%' OR citations LIKE '%flu%' OR citations LIKE '%cold%' OR citations LIKE '%bone%fracture%';""")
